    ...
    >
      {items.map((item: any, idx: any) => (
        ...
        >
          ...
          <Card>
            <CardTitle>{item.repository_name}</CardTitle>
            <CardTitle className="text text-green-700">$ {item.bounty}</CardTitle>
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-cyan-700 border border-transparent dark:border-white/[0.2] group-hover:border-slate-700 relative z-20",
        className
      )}
    >
